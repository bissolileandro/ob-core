...
namespace ob.core.data.Migrations
{
    ...
    [Migration("20230822202130_v0.0.4")]
    partial class v004
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ob.core.domain.Entities.PerfilUsuario", b =>
                {
                    ...
                    b.Property<DateTime>("DataDeAtualizacao")
                        ...
                        .HasDefaultValue(new DateTime(2023, 8, 22, 17, 21, 29, 864, DateTimeKind.Local).AddTicks(5126));

                    b.Property<DateTime>("DataDeCriacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 8, 22, 17, 21, 29, 864, DateTimeKind.Local).AddTicks(4297));
            ...
            modelBuilder.Entity("ob.core.domain.Entities.Usuario", b =>
                {
                    ...
                    b.Property<DateTime>("DataDeAtualizacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 8, 22, 17, 21, 29, 865, DateTimeKind.Local).AddTicks(1560));

                    b.Property<DateTime>("DataDeCriacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 8, 22, 17, 21, 29, 865, DateTimeKind.Local).AddTicks(901));
            ...
            modelBuilder.Entity("ob.core.domain.Entities.UsuarioLead", b =>
                {
                    ...
                    b.Property<DateTime>("DataDeAtualizacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 8, 22, 17, 21, 29, 866, DateTimeKind.Local).AddTicks(7223));

                    b.Property<DateTime>("DataDeCriacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 8, 22, 17, 21, 29, 866, DateTimeKind.Local).AddTicks(6739));
