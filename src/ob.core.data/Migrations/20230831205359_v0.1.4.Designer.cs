...
namespace ob.core.data.Migrations
{
    ...
    [Migration("20230831205359_v0.1.4")]
    partial class v014
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ob.core.domain.Entities.Cotacao", b =>
                {
                    ...
                    b.Property<DateTime>("DataDeAtualizacao")
                        ...
                        .HasDefaultValue(new DateTime(2023, 8, 31, 17, 53, 59, 25, DateTimeKind.Local).AddTicks(5984));

                    b.Property<DateTime>("DataDeCriacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 8, 31, 17, 53, 59, 25, DateTimeKind.Local).AddTicks(5758));
            ...
            modelBuilder.Entity("ob.core.domain.Entities.CotacaoVeiculo", b =>
                {
                    ...
                    b.Property<DateTime>("DataDeAtualizacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 8, 31, 17, 53, 59, 27, DateTimeKind.Local).AddTicks(4060));

                    b.Property<DateTime>("DataDeCriacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 8, 31, 17, 53, 59, 27, DateTimeKind.Local).AddTicks(3918));
            ...
            modelBuilder.Entity("ob.core.domain.Entities.ParametrosDeSistema", b =>
                {
                    ...
                    b.Property<DateTime>("DataDeAtualizacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 8, 31, 17, 53, 59, 28, DateTimeKind.Local).AddTicks(7935));

                    b.Property<DateTime>("DataDeCriacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 8, 31, 17, 53, 59, 28, DateTimeKind.Local).AddTicks(7716));
            ...
            modelBuilder.Entity("ob.core.domain.Entities.PerfilUsuario", b =>
                {
                    ...
                    b.Property<DateTime>("DataDeAtualizacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 8, 31, 17, 53, 59, 30, DateTimeKind.Local).AddTicks(4860));

                    b.Property<DateTime>("DataDeCriacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 8, 31, 17, 53, 59, 30, DateTimeKind.Local).AddTicks(4609));
            ...
            modelBuilder.Entity("ob.core.domain.Entities.Sistema", b =>
                {
                    ...
                    b.Property<Guid>("ChaveDeAcesso")
                        ...
                        .HasDefaultValue(new Guid("a42a7fda-5a73-47ae-83ae-21eacb32e6b9"));

                    b.Property<DateTime>("DataDeAtualizacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 8, 31, 17, 53, 59, 30, DateTimeKind.Local).AddTicks(7092));

                    b.Property<DateTime>("DataDeCriacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 8, 31, 17, 53, 59, 30, DateTimeKind.Local).AddTicks(6851));
            ...
            modelBuilder.Entity("ob.core.domain.Entities.Usuario", b =>
                {
                    ...
                    b.Property<DateTime>("DataDeAtualizacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 8, 31, 17, 53, 59, 30, DateTimeKind.Local).AddTicks(9833));

                    b.Property<DateTime>("DataDeCriacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 8, 31, 17, 53, 59, 30, DateTimeKind.Local).AddTicks(9604));
            ...
            modelBuilder.Entity("ob.core.domain.Entities.UsuarioLead", b =>
                {
                    ...
                    b.Property<DateTime>("DataDeAtualizacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 8, 31, 17, 53, 59, 31, DateTimeKind.Local).AddTicks(5805));

                    b.Property<DateTime>("DataDeCriacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 8, 31, 17, 53, 59, 31, DateTimeKind.Local).AddTicks(5603));
