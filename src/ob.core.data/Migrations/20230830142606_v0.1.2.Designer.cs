...
namespace ob.core.data.Migrations
{
    ...
    [Migration("20230830142606_v0.1.2")]
    partial class v012
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ob.core.domain.Entities.ParametrosDeSistema", b =>
                {
                    ...
                    b.Property<DateTime>("DataDeAtualizacao")
                        ...
                        .HasDefaultValue(new DateTime(2023, 8, 30, 11, 26, 6, 759, DateTimeKind.Local).AddTicks(5923));

                    b.Property<DateTime>("DataDeCriacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 8, 30, 11, 26, 6, 759, DateTimeKind.Local).AddTicks(5700));
            ...
            modelBuilder.Entity("ob.core.domain.Entities.PerfilUsuario", b =>
                {
                    ...
                    b.Property<DateTime>("DataDeAtualizacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 8, 30, 11, 26, 6, 761, DateTimeKind.Local).AddTicks(1135));

                    b.Property<DateTime>("DataDeCriacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 8, 30, 11, 26, 6, 761, DateTimeKind.Local).AddTicks(928));
            ...
            modelBuilder.Entity("ob.core.domain.Entities.Sistema", b =>
                {
                    ...
                    b.Property<Guid>("ChaveDeAcesso")
                        ...
                        .HasDefaultValue(new Guid("92dd0267-6cf6-4b76-87e0-85924cd40278"));

                    b.Property<DateTime>("DataDeAtualizacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 8, 30, 11, 26, 6, 761, DateTimeKind.Local).AddTicks(2987));

                    b.Property<DateTime>("DataDeCriacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 8, 30, 11, 26, 6, 761, DateTimeKind.Local).AddTicks(2722));
            ...
            modelBuilder.Entity("ob.core.domain.Entities.Usuario", b =>
                {
                    ...
                    b.Property<DateTime>("DataDeAtualizacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 8, 30, 11, 26, 6, 761, DateTimeKind.Local).AddTicks(5266));

                    b.Property<DateTime>("DataDeCriacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 8, 30, 11, 26, 6, 761, DateTimeKind.Local).AddTicks(5037));
            ...
            modelBuilder.Entity("ob.core.domain.Entities.UsuarioLead", b =>
                {
                    ...
                    b.Property<DateTime>("DataDeAtualizacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 8, 30, 11, 26, 6, 762, DateTimeKind.Local).AddTicks(716));

                    b.Property<DateTime>("DataDeCriacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 8, 30, 11, 26, 6, 762, DateTimeKind.Local).AddTicks(382));
