...
namespace ob.core.data.Migrations
{
    ...
    [Migration("20230817195902_v0.0.1")]
    partial class v001
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ob.core.domain.Entities.PerfilUsuario", b =>
                {
                    ...
                    b.Property<DateTime>("DataDeAtualizacao")
                        ...
                        .HasDefaultValue(new DateTime(2023, 8, 17, 16, 59, 2, 67, DateTimeKind.Local).AddTicks(8398));

                    b.Property<DateTime>("DataDeCriacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 8, 17, 16, 59, 2, 67, DateTimeKind.Local).AddTicks(8193));
            ...
            modelBuilder.Entity("ob.core.domain.Entities.Usuario", b =>
                {
                    ...
                    b.Property<DateTime>("DataDeAtualizacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 8, 17, 16, 59, 2, 68, DateTimeKind.Local).AddTicks(622));

                    b.Property<DateTime>("DataDeCriacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 8, 17, 16, 59, 2, 68, DateTimeKind.Local).AddTicks(396));
