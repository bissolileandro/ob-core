...
namespace ob.core.data.Migrations
{
    ...
    [Migration("20230904125203_v0.1.5")]
    partial class v015
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ob.core.domain.Entities.Cotacao", b =>
                {
                    ...
                    b.Property<DateTime>("DataDeAtualizacao")
                        ...
                        .HasDefaultValue(new DateTime(2023, 9, 4, 9, 52, 3, 900, DateTimeKind.Local).AddTicks(3651));

                    b.Property<DateTime>("DataDeCriacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 9, 4, 9, 52, 3, 900, DateTimeKind.Local).AddTicks(3412));
            ...
            modelBuilder.Entity("ob.core.domain.Entities.CotacaoVeiculo", b =>
                {
                    ...
                    b.Property<DateTime>("DataDeAtualizacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 9, 4, 9, 52, 3, 902, DateTimeKind.Local).AddTicks(600));

                    b.Property<DateTime>("DataDeCriacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 9, 4, 9, 52, 3, 902, DateTimeKind.Local).AddTicks(459));
            ...
            modelBuilder.Entity("ob.core.domain.Entities.ParametrosDeSistema", b =>
                {
                    ...
                    b.Property<DateTime>("DataDeAtualizacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 9, 4, 9, 52, 3, 903, DateTimeKind.Local).AddTicks(5068));

                    b.Property<DateTime>("DataDeCriacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 9, 4, 9, 52, 3, 903, DateTimeKind.Local).AddTicks(4792));
            ...
            modelBuilder.Entity("ob.core.domain.Entities.PerfilUsuario", b =>
                {
                    ...
                    b.Property<DateTime>("DataDeAtualizacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 9, 4, 9, 52, 3, 905, DateTimeKind.Local).AddTicks(1725));

                    b.Property<DateTime>("DataDeCriacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 9, 4, 9, 52, 3, 905, DateTimeKind.Local).AddTicks(1254));
            ...
            modelBuilder.Entity("ob.core.domain.Entities.Sistema", b =>
                {
                    ...
                    b.Property<Guid>("ChaveDeAcesso")
                        ...
                        .HasDefaultValue(new Guid("5963f2f4-6a3b-4e5d-ab28-65338692aab6"));

                    b.Property<DateTime>("DataDeAtualizacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 9, 4, 9, 52, 3, 905, DateTimeKind.Local).AddTicks(6018));

                    b.Property<DateTime>("DataDeCriacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 9, 4, 9, 52, 3, 905, DateTimeKind.Local).AddTicks(5731));
            ...
            modelBuilder.Entity("ob.core.domain.Entities.Usuario", b =>
                {
                    ...
                    b.Property<DateTime>("DataDeAtualizacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 9, 4, 9, 52, 3, 905, DateTimeKind.Local).AddTicks(8930));

                    b.Property<DateTime>("DataDeCriacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 9, 4, 9, 52, 3, 905, DateTimeKind.Local).AddTicks(8646));
            ...
            modelBuilder.Entity("ob.core.domain.Entities.UsuarioLead", b =>
                {
                    ...
                    b.Property<DateTime>("DataDeAtualizacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 9, 4, 9, 52, 3, 906, DateTimeKind.Local).AddTicks(5110));

                    b.Property<DateTime>("DataDeCriacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 9, 4, 9, 52, 3, 906, DateTimeKind.Local).AddTicks(4919));
