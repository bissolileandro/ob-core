...
namespace ob.core.data.Migrations
{
    ...
    [Migration("20230817200322_v0.0.2")]
    partial class v002
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ob.core.domain.Entities.PerfilUsuario", b =>
                {
                    ...
                    b.Property<DateTime>("DataDeAtualizacao")
                        ...
                        .HasDefaultValue(new DateTime(2023, 8, 17, 17, 3, 22, 233, DateTimeKind.Local).AddTicks(6115));

                    b.Property<DateTime>("DataDeCriacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 8, 17, 17, 3, 22, 233, DateTimeKind.Local).AddTicks(5882));
            ...
            modelBuilder.Entity("ob.core.domain.Entities.Usuario", b =>
                {
                    ...
                    b.Property<DateTime>("DataDeAtualizacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 8, 17, 17, 3, 22, 233, DateTimeKind.Local).AddTicks(8833));

                    b.Property<DateTime>("DataDeCriacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 8, 17, 17, 3, 22, 233, DateTimeKind.Local).AddTicks(8559));
