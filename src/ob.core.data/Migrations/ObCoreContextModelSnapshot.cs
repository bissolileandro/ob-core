...
namespace ob.core.data.Migrations
{
    ...
    partial class ObCoreContextModelSnapshot : ModelSnapshot
    {
            ...
            modelBuilder.Entity("ob.core.domain.Entities.CarteiraCashBackLancamentos", b =>
                {
                    ...
                    b.Property<DateTime>("DataDeAtualizacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 19, 18, 14, 35, 532, DateTimeKind.Local).AddTicks(6905));

                    b.Property<DateTime>("DataDeCriacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 19, 18, 14, 35, 532, DateTimeKind.Local).AddTicks(6601));
            ...
            modelBuilder.Entity("ob.core.domain.Entities.CarteiraCashback", b =>
                {
                    ...
                    b.Property<DateTime>("DataDeAtualizacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 19, 18, 14, 35, 532, DateTimeKind.Local).AddTicks(4539));

                    b.Property<DateTime>("DataDeCriacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 19, 18, 14, 35, 532, DateTimeKind.Local).AddTicks(4359));
            ...
            modelBuilder.Entity("ob.core.domain.Entities.Cotacao", b =>
                {
                    ...
                    b.Property<DateTime>("DataDeAtualizacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 19, 18, 14, 35, 534, DateTimeKind.Local).AddTicks(6797));

                    b.Property<DateTime>("DataDeCriacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 19, 18, 14, 35, 534, DateTimeKind.Local).AddTicks(6612));
            ...
            modelBuilder.Entity("ob.core.domain.Entities.CotacaoVeiculo", b =>
                {
                    ...
                    b.Property<DateTime>("DataDeAtualizacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 19, 18, 14, 35, 536, DateTimeKind.Local).AddTicks(1499));

                    b.Property<DateTime>("DataDeCriacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 19, 18, 14, 35, 536, DateTimeKind.Local).AddTicks(1361));
            ...
            modelBuilder.Entity("ob.core.domain.Entities.EmailConfiguracao", b =>
                {
                    ...
                    b.Property<DateTime>("DataDeAtualizacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 19, 18, 14, 35, 536, DateTimeKind.Local).AddTicks(6528));

                    b.Property<DateTime>("DataDeCriacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 19, 18, 14, 35, 536, DateTimeKind.Local).AddTicks(6348));
            ...
            modelBuilder.Entity("ob.core.domain.Entities.FaqSistema", b =>
                {
                    ...
                    b.Property<DateTime>("DataDeAtualizacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 19, 18, 14, 35, 538, DateTimeKind.Local).AddTicks(6911));

                    b.Property<DateTime>("DataDeCriacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 19, 18, 14, 35, 538, DateTimeKind.Local).AddTicks(6723));
            ...
            modelBuilder.Entity("ob.core.domain.Entities.ParametrosDeSistema", b =>
                {
                    ...
                    b.Property<DateTime>("DataDeAtualizacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 19, 18, 14, 35, 538, DateTimeKind.Local).AddTicks(8887));

                    b.Property<DateTime>("DataDeCriacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 19, 18, 14, 35, 538, DateTimeKind.Local).AddTicks(8651));
            ...
            modelBuilder.Entity("ob.core.domain.Entities.PerfilUsuario", b =>
                {
                    ...
                    b.Property<DateTime>("DataDeAtualizacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 19, 18, 14, 35, 539, DateTimeKind.Local).AddTicks(1317));

                    b.Property<DateTime>("DataDeCriacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 19, 18, 14, 35, 539, DateTimeKind.Local).AddTicks(563));
            ...
            modelBuilder.Entity("ob.core.domain.Entities.Sistema", b =>
                {
                    ...
                    b.Property<Guid>("ChaveDeAcesso")
                        ...
                        .HasDefaultValue(new Guid("1eef1a8d-86bf-4a9b-91ab-5054d462274d"));

                    b.Property<DateTime>("DataDeAtualizacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 19, 18, 14, 35, 539, DateTimeKind.Local).AddTicks(2821));

                    b.Property<DateTime>("DataDeCriacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 19, 18, 14, 35, 539, DateTimeKind.Local).AddTicks(2614));
            ...
            modelBuilder.Entity("ob.core.domain.Entities.Usuario", b =>
                {
                    ...
                    b.Property<DateTime>("DataDeAtualizacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 19, 18, 14, 35, 539, DateTimeKind.Local).AddTicks(5232));

                    b.Property<DateTime>("DataDeCriacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 19, 18, 14, 35, 539, DateTimeKind.Local).AddTicks(5013));
                    ...
                    b.Property<string>("LinkRedefinirSennha")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("ob.core.domain.Entities.UsuarioGuardaChuva", b =>
                {
                    ...
                    b.Property<DateTime>("DataDeAtualizacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 19, 18, 14, 35, 539, DateTimeKind.Local).AddTicks(6952));

                    b.Property<DateTime>("DataDeCriacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 19, 18, 14, 35, 539, DateTimeKind.Local).AddTicks(6727));
            ...
            modelBuilder.Entity("ob.core.domain.Entities.UsuarioLead", b =>
                {
                    ...
                    b.Property<DateTime>("DataDeAtualizacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 19, 18, 14, 35, 540, DateTimeKind.Local).AddTicks(2129));

                    b.Property<DateTime>("DataDeCriacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 19, 18, 14, 35, 540, DateTimeKind.Local).AddTicks(1951));
